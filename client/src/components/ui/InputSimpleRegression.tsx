...
const InputSimpleRegression = (props : Props) => {
  ...
  const handleMorder = (e: React.ChangeEvent<HTMLInputElement>) => {
    setM(e.target.value as unknown as number);
  }
    ...
    <div className="w-full mt-10 flex justify-center items-center flex-col">
       <div className="flex gap-2 justify-center items-center">
          ...
          <div className="flex flex-col gap-2 justify-center items-center">
            <span>MOrder</span>
            <div className="flex gap-2">
              <button className="btn hover:bg-rose-400 hover:text-white" onClick={()=> {(M>1) && setM(M-1)}}>-</button>
              <input
                type="number"
                className="rounded-md px-5 py-2 w-[150px] text-center"
                placeholder="N"
                value={M}
                onChange={handleMorder}
              />
              <button className="btn hover:bg-green-400 hover:text-white" onClick={()=>setM(M+1)}>+</button>
            </div>
          </div>
...
export default InputSimpleRegression;
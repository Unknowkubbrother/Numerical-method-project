...
import { falsePositionMethod , FalsePositionResponse, FalsePositionRequest} from "../../../Methods/rootMethods/falsePosition";
    ...
    if (Id != null) {
      new Promise((resolve) => {
        ...
        .then((result: unknown) => {
          ...
          const input = data.input as FalsePositionRequest;
          setxL(input.xL);
          setxR(input.xR);
      ...
      <div className="w-full flex min-[340px]:flex-col lg:flex-row gap-5 min-[340px]:justify-center min-[340px]:items-center lg:justify-start lg:items-start">
        ...
        <div className="min-[340px]:w-full lg:w-[85%] xl:w-[73.5%] h-[550px] rounded-lg pt-5 px-5 flex flex-col bg-white">
          ...
          <div className="w-full h-full">
            <Graph data={Data as FalsePositionResponse} func={Data ? equation : null}/>
          </div>
        </div>
      </div>
